...
def insert_data(name, email, res_score, timestamp, no_of_pages, reco_field, cand_level, skills, 
recommended_skills,
 courses):
...
def run():
 ...
 img = Image.open('./Logo/pexels-pixabay-356830.jpg')
 #img = img.resize((250, 250))
 st.image(img)
 # Create the DB
 db_sql = """CREATE DATABASE IF NOT EXISTS SRA;"""
 cursor.execute(db_sql)
 connection.select_db("srra")
 # Create table
 DB_table_name = 'user_data'
...
will show your personality to the Recruiters and give assurance that you are fit for this role or 
not.</p>
 </div>
 ''',
 unsafe_allow_html=True)
